...
export const mockSessions: Session[] = [
  ...
  },
  {
    ...
    courseId: "inno",
    type: "lecture",
    title: 'LV "Ziele, Zielgruppen, Personas"',
...
export const mockCoachingSlots: CoachingSlot[] = [
  {
    ...
    duration: "45m",
    maxParticipants: 4,
    participants: ["Markus", "Emanuel", "Bence", "Natalia"],
    description: "111 Coaching für Data Science Fragen",
