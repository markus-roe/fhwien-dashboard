                        ...
                        <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0 cursor-pointer" onClick={() => onSessionClick(session)}>
                            <div className="flex flex-col sm:flex-row sm:items-start gap-3 mb-2">
                                ...
                                <div className="flex items-center gap-2 mb-1">
                                  <span
                                    className={`text-[10px] font-bold uppercase tracking-wide ${
                                      session.type === "coaching" ? "text-amber-600" : "text-[var(--primary)]" 
                                    }`}
                                  >
                              ...
                              <button
                                className="flex-shrink-0 text-xs font-medium text-[var(--primary)] hover:text-[var(--primary)]/80 px-3 py-1.5 rounded-md hover:bg-[var(--primary)]/10 transition-colors sm:mt-0 mt-2 sm:w-auto w-full"
                              >
                                Details anzeigen
                              </button>
                            </div>
