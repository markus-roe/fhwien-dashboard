  ...
  return (
    <div className="bg-white rounded-xl border border-zinc-200 p-3 sm:p-5 shadow-sm">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h3 className="text-xs sm:text-sm font-medium text-zinc-900">Nächste 7 Tage</h3>
      </div>
            ...
            <div className="space-y-2 sm:space-y-3 relative">
              ...
              {day.sessions.map((session, sessionIndex) => (
                ...
                >
                  ...
                  >
                    <h4 className="text-xs font-semibold text-zinc-900 group-hover:text-[var(--primary)] transition-colors line-clamp-2">
                      {session.title}
                    </h4>
